    ...
    <footer className="w-full max-w-[760px] mx-auto px-4 py-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold text-nm-text">NEAR Mobile Wallet</span>
        </div>

        {/* Right - Links */}
        <div className="flex items-center gap-6 text-sm text-nm-muted">
          <span>© 2025 Peersyst Technology</span>
